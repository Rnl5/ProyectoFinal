...
namespace ProyectoFinalECommerce.Migrations
{
    ...
    [Migration("20231206212036_Agregando los modelos del telefono en el context")]
    partial class Agregandolosmodelosdeltelefonoenelcontext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoFinalECommerce.Model.TelefonosUsuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TipoTelId = 4,
                            TipoTel = "Persona Auxiliar"
                        });
                });

            modelBuilder.Entity("ProyectoFinalECommerce.Model.UsuariosDetalle", b =>
                {
            ...
            modelBuilder.Entity("ProyectoFinalECommerce.Model.UsuariosDetalle", b =>
                {
                    ...
                    b.HasOne("ProyectoFinalECommerce.Model.TelefonosUsuario", null)
                        .WithMany("UsuariosDetalle")
                        .HasForeignKey("TipoTelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
